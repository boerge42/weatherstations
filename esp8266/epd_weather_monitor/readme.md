...
Sinnvollerweise richtet man dieses Programm als Service auf dem Raspberry Pi ein, damit es beim Start des Rechners automatisch gestartet wird (via *systemd* siehe epd_weather_monitor.service).
